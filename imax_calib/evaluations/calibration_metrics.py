...
def compute_top_1_and_CW_ECEs(multi_cls_probs, multi_cls_labels, list_approximators=["dECE", "mECE", "iECE", "kECE"], num_bins=100):
    """
    ...
    for ece_approx in list_approximators:
        ...
        for class_idx in range(n_classes):
            cw_ECE = eval("measure_%s_calibration"%(ece_approx))(pred_probs=multi_cls_probs[:, class_idx], correct=multi_cls_labels[:, class_idx], num_bins=num_bins, threshold=1.0/n_classes)["ece"]
